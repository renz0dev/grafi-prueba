...
const BrandBar = () => {
  ...
  const logos = [
    "/src/assets/logo/intel-logo2.png",
    "/src/assets/logo/amd-logo2.png",
    "/src/assets/logo/nvidia-logo.png",
    "/src/assets/logo/brother-svg.svg",
    "/src/assets/logo/epson-svg.svg",
    "/src/assets/logo/canon-logo.png",
    "/src/assets/logo/hp-webp.webp",
  ];
