...
const CategoryNav = () => {
  ...
  return (
    <nav className="bg-cyan-500 sticky top-0 z-50">
            ...
            >
              <ul>
                <li className="px-4 py-2 hover:bg-gray-200 cursor-pointer text-black">
                  <NavLink to="/categorias/procesadores" className="flex items-center gap-2">
                    <GiProcessor size={20} />
                    Procesadores
                  </NavLink>
                </li>
                <li className="px-4 py-2 hover:bg-gray-200 cursor-pointer text-black">
                  <NavLink to="/categorias/impresoras" className="flex items-center gap-2">
                    <BsMotherboard size={20} />
                    Impresoras
                  </NavLink>
                </li>
                <li className="px-4 py-2 hover:bg-gray-200 cursor-pointer text-black">
                  <NavLink to="/categorias/perifericos" className="flex items-center gap-2">
                    <BsMouse size={20} />
                    Periféricos
                  </NavLink>
                </li>
                <li className="px-4 py-2 hover:bg-gray-200 cursor-pointer text-black">
                  <NavLink to="/categorias/monitores" className="flex items-center gap-2">
                    <CiMonitor size={20} />
                    Monitores
                  </NavLink>
                </li>
                <li className="px-4 py-2 hover:bg-gray-200 cursor-pointer text-black">
                  <NavLink to="/categorias/tintas" className="flex items-center gap-2">
                    <RiInkBottleLine size={20} />
                    Tintas
                  </NavLink>
                </li>
                <li className="px-4 py-2 hover:bg-gray-200 cursor-pointer text-black">
                  <NavLink to="/categorias/laptops" className="flex items-center gap-2">
                    <CiLaptop size={20} />
                    Laptops
                  </NavLink>
                </li>
