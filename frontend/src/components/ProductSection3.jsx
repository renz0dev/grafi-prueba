...
const ProductSection3 = () => {
  ...
  useEffect(() => {
    ...
    axios.get("http://127.0.0.1:8000/api/products/?category=7", {
      headers: { Authorization: `Token ${token}` }
    })
    .then((response) => {
        //console.log("Productos recibidos:", response.data); // Asegúrate de esto
        setProducts(response.data.results || response.data || []);
        //console.log("Estado actualizado con productos:", response.data.results || response.data || []);
        setLoading(false);
    })
    .catch((error2) => {
        console.error("Error al cargar los productos:", error2.response?.data || error2.message);
      ...
      <div className="container mx-auto px-0 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="relative w-[264px] h-[414px] aspect-square rounded-lg overflow-hidden bg-black">
              ...
              <NavLink to="/categorias/laptops">
                <img
                  src="/src/assets/new-laptop.jpg"
                  alt="Lo nuevo en Laptops"
          ...
          <div className="lg:col-span-4">
            <h2 className="text-3xl font-bold text-black mb-8 px-8">Laptops</h2>
            <div className="px-4">
              <Slider {...settings}>
